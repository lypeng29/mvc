...
/**
 * Test控制器，各种测试类控制器
 * 包含缓存File|Memcache(d)|Db|Redis、上传、日志L、输出Apihelper、发送邮件
 */
...
eof;
    ...
    public function sendemail($subject='Here is the subject',$body='This is the HTML message body <b>in bold!</b>')
    {
