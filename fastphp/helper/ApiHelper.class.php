	...
	public static function output($errorCode = 0, $errorMessage = '', $format='json'){
		...
		if($format == 'json'){
			...
			if(!headers_sent()){
				...
				if(strstr($userAgent, 'MSIE 9') || strstr($userAgent, 'MSIE 7') || strstr($userAgent, 'MSIE 8') || strstr($userAgent, 'MSIE 10') || strstr($userAgent, 'MSIE 11')){
					// IE下不输出content-type
